...
<div>
    ...
    <div style="text-align: center; font-weight: bold" v-show="step==1">
        ...
        <div>
            ...
            <a-button @click="handleSubmitUserId" shape="round" style="font-weight: bold; font-size: 18px">提交</a-button>
        </div>
        </a-spin>
    </div>
    <!-- STEP2: 发送邮件/输入验证码 -->
    <div style="text-align: center; font-weight: bold" v-show="step==2">
        <div>
            ...
            <a-button @click="handleSubmitVerificationCode" shape="round" style="font-weight: bold; font-size: 18px">提交</a-button>
        </div>
    </div>
    <div style="text-align: center; font-weight: bold" v-show="step==3">
        ...
        @click="this.$router.push({name: 'Login', params: {id: this.userId, password: this.password}})"
        >前往登录</a-button>
        </div>
    </div>
</div>
