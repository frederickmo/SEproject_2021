              ...
              <div style="text-align: left">
                  ...
                  <a-spin :loading="loading2" tip="验证码检验中，请稍等……">
                    <div v-show="step==2">
                        ...
                        <div style="height: 30px" />
                        <div>
                            <a-button shape="round" style="margin-right: 20px" @click="handleSubmitVerificationCode">确认提交</a-button>
                  ...
                  <div v-show="step==3">
                    ...
                    <a-form ref="formRef" :model="passwords">
                        ...
                        <div style="margin-top: 30px">
                            <a-button shape="round" style="margin-right: 20px; margin-left: 12%" @click="handleSubmitNewPassword">确认提交</a-button>
                            <a-button shape="round" @click="this.$router.replace({path: '/refresh'})">返回</a-button>
                        </div>
                    </a-form>
                    <div style="height: 30px" />
