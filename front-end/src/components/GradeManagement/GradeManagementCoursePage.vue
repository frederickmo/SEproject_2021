  ...
  <div>
    <div style="margin-bottom: 10px">
      <va-breadcrumbs separator=">">
        ...
        <va-breadcrumbs-item
          :label="this.Scorestatus == 1 ? '所有实验项目' : '课程成员成绩'"
          disabled
        />
      </va-breadcrumbs>
    </div>
    <va-card>
      ...
      <va-card-title style="font-size: 20px">{{
        this.Scorestatus == 1 ? "课程项目成绩" : "课程成员成绩"
      }}</va-card-title>
      <va-card-content v-show="tasks.length">
        <div>
          <div style="display: flex">
            <a-button style="margin-right: 10px" @click="this.Scorestatus = 1"
              >课程项目成绩</a-button
            >
        ...
        >
          ...
          <el-table-column align="right">
            ...
            <template #default="scope">
              <a-button style="margin-left: 10px" @click="handleMark(scope.row)"
                >评分</a-button
              >
            </template>
          </el-table-column>
