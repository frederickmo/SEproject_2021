        ...
        <el-card class="qu-content" v-for="(item,index) in questionData" :key="index">  
          ...
          <div v-if="item.questionType === 0">
            <el-radio-group v-model="item.questionanswer" @change="getValue()">
              ...
              <el-radio label="A">A. {{ item.questionSelectA }} <div style="clear: both" /></el-radio>
              <el-radio label="B">B. {{ item.questionSelectB }} <div style="clear: both" /></el-radio>
              <el-radio label="C">C. {{ item.questionSelectC }} <div style="clear: both" /></el-radio>
              <el-radio label="D">D. {{ item.questionSelectD }} <div style="clear: both" /></el-radio>
          ...
          <div v-if="item.questionType === 1">
            ...
            <el-checkbox-group v-model="item.questionanswer">
              <el-checkbox label="A">A. {{ item.questionSelectA }} <div style="clear: both" /></el-checkbox>
              <el-checkbox label="B">B. {{ item.questionSelectB }} <div style="clear: both" /></el-checkbox>
              <el-checkbox label="C">C. {{ item.questionSelectC }} <div style="clear: both" /></el-checkbox>
              <el-checkbox label="D">D. {{ item.questionSelectD }} <div style="clear: both" /></el-checkbox>
            </el-checkbox-group>
